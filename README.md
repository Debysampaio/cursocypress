...
Sample project for the baseic course of the talking about testing online school.
...
> I used versions `v18.15.0` and `v20.9.0 ` of Node.js and npm, respectively. I suggest you use the same or later versions.
